...
""" Description About UperNetKD4 Model
    ...
    - Apply Distillation loss to decoder
"""
class UperNetKD6Model(BaseModel):
    def __init__(self, opt):
        super(UperNetKD6Model, self).__init__(opt=opt)
    ...
    def get_loss(self, output, label):
        ...
        T_decode, S_decode = output[0][4], output[5]
        ...
        decode_loss = self.loss_mse(S_decode, T_decode)
