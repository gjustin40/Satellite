...
class BEiT(nn.Module):
    ...
    def __init__(self, img_size=512, patch_size=16, in_chans=3, num_classes=2, embed_dim=1024,
                 ...
                 init_values=1e-06, use_checkpoint=False, use_abs_pos_emb=False, use_rel_pos_bias=True,
                 use_shared_rel_pos_bias=False, pretrained=None, with_cp=True):
        super().__init__()
